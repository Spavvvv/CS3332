...
public interface ScreenView {
    ...
    /**
     Thiết lập NavigationController cho src.view
     @param navigationController Controller điều hướng
     */
    void setNavigationController(NavigationController navigationController);

    /**
     Thiết lập MainController cho src.view
     @param mainController Controller chính
     */
    void setMainController(MainController mainController);

    /**
     Lấy NavigationController đã được thiết lập cho src.view
     @return NavigationController được sử dụng bởi src.view
     */
    NavigationController getNavigationController();

    /**
     Lấy MainController đã được thiết lập cho src.view
     @return MainController được sử dụng bởi src.view
     */
