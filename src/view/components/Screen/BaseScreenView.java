...
public abstract class BaseScreenView implements ScreenView {
    ...
    protected String viewId = "base-src.view";
    ...
    @Override
    public Node getRoot() {
        // Đảm bảo src.view đã được khởi tạo khi yêu cầu root
        ensureInitialized();
        return root;
    }

    /**
     * Đảm bảo src.view đã được khởi tạo. Phương thức này được gọi
     * khi cần truy cập các thành phần đã khởi tạo của src.view.
     */
    ...
    public void onActivate() {
        // Đảm bảo src.view đã được khởi tạo trước khi active
        ensureInitialized();
        refreshView();
    }
    ...
    @Override
    public void onShow() {
        // Đảm bảo src.view đã được khởi tạo trước khi hiển thị
        ensureInitialized();
