...
import src.dao.Report.TeacherQuarterlyStatisticsDAO;
import javafx.collections.FXCollections;
import javafx.collections.ObservableList;
import src.model.teaching.quarterly.TeacherQuarterlyStatisticsModel;
import src.view.Report.QuarterlyTeachingStatisticsView;
...
public class QuarterlyTeachingStatisticsController {
    ...
    /**
     * Setup event handlers - called by the src.view
     */
    public void setupEventHandlers() {
        // Only setup handlers if src.view is initialized
        if (view == null) return;
    ...
    /**
     * Load initial data when src.view is activated
     */
    ...
    /**
     * Fetches data from the DAO and updates the src.view.
     *
    ...
    /**
     * Core method to fetch data from DAO and update the src.view.
