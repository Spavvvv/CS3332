...
// File: controller/ReportController.java (Hoặc src.controller.ReportController theo import của bạn)
package src.controller; // Hoặc package tương ứng của bạn
...
import view.components.ReportView; // Điều chỉnh package nếu cần
...
public class ReportController {
    ...
    private void loadClassStatuses() {
        try {
            ...
            System.out.println("ReportController: Calling view.setClassStatusOptions with " + statuses.size() + " items.");
    ...
    public void loadReportData() {
        ...
        try {
            ...
            System.out.println("ReportController: Data retrieved from model. Updating view.");
            // Bước 3: Cập nhật view với dữ liệu mới
            ...
            System.err.println("Error in loadReportData (Controller level) or updating view: " + e.getMessage());
            e.printStackTrace();
