...
import src.dao.Person.StudentDAO; // Assuming you still need this for student list by class
...
public class AbsenceCallController {
    ...
    public void loadSessionList() {
        try {
            ...
            if (view != null && !sessionListData.isEmpty()) {
                ...
                // src.view.selectSession(sessionListData.get(0));
                // applyFilters();
            } else if (view != null) {
    ...
    public void applyFilters() {
        ...
        if (dataChanged) {
            ...
            // if (!src.view.showConfirmation("Bạn có thay đổi chưa lưu. Bỏ qua các thay đổi này?")) {
    ...
    public void refreshData() {
        ...
        if (dataChanged) {
            ...
            // if (!src.view.showConfirmation("Bạn có thay đổi chưa lưu. Tiếp tục làm mới và bỏ qua thay đổi?")) {
            //     return;
            // }
        }
        ...
        if (currentSession != null && view != null) {
            ...
            sessionListData.stream()
                    ...
                    .findFirst()
                    .ifPresent(view::selectSession); // Re-select the session in the src.view
        }
        // applyFilters will be called by the src.view's session selector listener,
    ...
    public void handleSaveChanges() {
        ...
        for (AbsenceRecord ar : absenceData) {
            ...
            // Let's simplify: attempt to upsert all records from the src.view.
        ...
        try {
            ...
            setDataChanged(false);
            // Refresh data from DB to ensure src.view is consistent
    ...
    public void setDataChanged(boolean changed) {
        ...
        // You could notify the src.view to enable/disable save button, e.g., src.view.setSaveButtonEnabled(changed);
    }
