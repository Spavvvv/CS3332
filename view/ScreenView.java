...
public interface ScreenView {
    ...
    /**
     Lấy NavigationController đã được thiết lập cho view
     @return NavigationController được sử dụng bởi view
     */
    NavigationController getNavigationController();

    /**
     Lấy MainController đã được thiết lập cho view
     @return MainController được sử dụng bởi view
     */
