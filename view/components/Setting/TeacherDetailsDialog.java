package view.components.Setting;
...
public class TeacherDetailsDialog extends Dialog<Boolean> { // Trả về Boolean (true nếu có thay đổi, false nếu không)
    ...
    private final SettingView.TeacherPlaceholder placeholder;

    public TeacherDetailsDialog(Window owner, SettingView.TeacherPlaceholder placeholder, Teacher teacherModel) {
